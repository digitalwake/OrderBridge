...
@@library="t37files"
	...
	def write_order_header_drop_ship(dbh,po,cust,ship_to,date,notes)
		...
		dbh.execute("Insert into #{@@library}.vedxpohw(EHCMP,EHTYPE,EHCUST,EHPONO,EHSHIP,EHDDT8) 
	...
	def write_order_detail_drop_ship(dbh,cust,po,line,item,cust_item,uom,ship_to,qty)
		...
		dbh.execute("Insert into #{@@library}.vedxpodh(EWCMP,EWTYPE,EWPONO,EWLINE, EWITEM, EWSHTO, EWOQTY, EWSTYL, EWUM, EWCUST) 
	...
	def write_order_header(dbh,po,cust,ship_to,date,notes)
		...
		dbh.execute("Insert into #{@@library}.vedxpohw(EHCMP,EHCUST,EHPONO,EHSHIP,EHDDT8) 
	...
	def write_order_detail(dbh,cust,po,line,item,cust_item,uom,ship_to,qty)
		...
		dbh.execute("Insert into #{@@library}.vedxpodh(EWCMP,EWPONO,EWLINE,EWITEM,EWSHTO,EWOQTY,EWSTYL,EWUM,EWCUST) 
