class OrderWriter
	...
	def write_order_detail_drop_ship(dbh,cust,po,line,item,cust_item,uom,ship_to,qty)
		...
		dbh.execute("Insert into t37files.vedxpodh(EWCMP,EWTYPE,EWPONO,EWLINE, EWITEM, EWSHTO, EWOQTY, EWSTYL, EWUM, EWCUST) 
	...
	def write_order_detail(dbh,cust,po,line,item,cust_item,uom,ship_to,qty)
		...
		dbh.execute("Insert into t37files.vedxpodh(EWCMP,EWPONO,EWLINE,EWITEM,EWSHTO,EWOQTY,EWSTYL,EWUM,EWCUST) 
